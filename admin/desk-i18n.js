...
(function (global) {
  ...
  const DICT = {
    jp: {
      ...
      btnConfirmBooking: '予約を確認',
      bookingReadonly: '内容を確認できます',
      bookingConfirmHint: '2名以上の予約です。内容を確認して「予約を確認」を押してください。',
      bookingConfirmed: '予約を確認しました',
      ...
      bedsUnit: 'ベッド',
      // CS
      dailyEmailTime: '毎日の店舗メール（日本時間）',
      saveDailyTime: '送信時刻を保存',
      previewDigest: '日次サマリーをプレビュー',
      exportData: 'データ書き出し',
      calIssueMissingStart: '開始時刻なし',
      calIssueMissingName: '氏名なし',
      calIssueMissingService: 'コースなし',
      calIssueMissingBeds: 'ベッド未指定',
      importCalendar: 'カレンダーを今すぐ同期',
      pushCalendar: 'カレンダーへ推送',
      pushCalendarHint: '当日の確定予約を店のカレンダーへ書き込みます。店側の元イベントは消しません。',
      pushCalendarOk: 'カレンダーへ推送しました',
      pushCalendarFail: 'カレンダー推送に失敗',
      prevDay: '前の日',
      nextDay: '次の日',
      nextDayMark: '翌日',
      importJson: 'バックアップ取込',
      resetData: '当店のテストデータを消去',
      slotGuideTitle: '空き枠の最早開始（既存予約を考慮）',
      slotGuideHint: '当日のベッド占用と現在時刻を見て、何人・何分なら次に入れるか。間隔0分で既存予約に接する場合は「切れ目なし」と表示。',
      calPagesHint: 'オンラインは店のカレンダーを同期しません。操作確認用です。実データは本機の看板で見てください。',
      slotGuideDur: '分数',
      slotGuideGuestEarliest: '人の最早',
      slotGuideEarliest: '最も早い開始',
      slotGuideLatest: '最も遅い開始（閉店までに終了）',
      slotGuideNone: 'この営業時間では不可',
      slotGuideFull: '空きなし',
      slotSeamHint: '切れ目なし',
      slotSeamBefore: '前が連続',
      slotSeamAfter: '後が連続',
      slotSeamBoth: '前後とも連続',
      minGap: '間隔の最低時間（分）',
      minGapHint: '同じベッドで次の予約を入れるまでの最短空き。0＝隙間なし可。',
      ...
      storeOpen: '開店',
      storeClose: '閉店',
      storeOvernight: '深夜営業（閉店が開店より早い）',
      hoursHint: 'ボードの時間軸はこの店の営業時間で描画します。',
      editResources: 'リソースとコースを編集',
      editHintNormal: '普段はカードをタップしてCSへ',
      editHintOn: '編集モード：右上の言語を切り替えると、その言語の名称だけ直します。',
      doneEdit: '編集完了',
      ...
      coursesLabel: '予約コース（いまの言語。1行1件：「id|名称」または名称）',
      resCount: 'リソース数',
      resNames: 'リソース名（いまの言語）',
      editLangNow: '編集中の言語',
      editLangJp: '日本語',
      editLangCn: '中国語',
      editLangEn: '英語',
      editLangHint: '右上の JP / 中 / EN を切り替えて、3言語を別々に保存できます。',
      resTypeHint:
        '名称を編集し、種類（シングル / ペア / VIP）を選択。各リソースは独立して予約できます。',
      resNamePh: '名称（例：シングル1）',
      resType: '種類',
    },
    cn: {
      lang: '语言',
      ...
      btnConfirmBooking: '确认预约',
      bookingReadonly: '可查看预约详情',
      bookingConfirmHint: '≥2 人预约，请核对后点击「确认预约」。确认后变为已确认（蓝色）。',
      bookingConfirmed: '已确认预约',
      ...
      resourcesUnit: '床位',
      bedsUnit: '床位',
      dailyEmailTime: '每日商家邮件（日本时间）',
      saveDailyTime: '保存发送时刻',
      previewDigest: '预览每日汇总邮件',
      exportData: '导出数据',
      calIssueMissingStart: '缺起始时间',
      calIssueMissingName: '缺姓名',
      calIssueMissingService: '缺项目',
      calIssueMissingBeds: '缺床位',
      importCalendar: '立即同步日历',
      pushCalendar: '推日历',
      pushCalendarHint: '把当日已确认预约写入店家日历。不会删店家原来的事件。',
      pushCalendarOk: '已推到日历',
      pushCalendarFail: '推日历失败',
      prevDay: '前一日',
      nextDay: '后一日',
      nextDayMark: '第二天',
      importJson: '导入备份',
      resetData: '清空本店测试数据',
      slotGuideTitle: '新单最早可约（已算上现有预约）',
      slotGuideHint: '按当天床位占用和现在时刻扫描。间隔默认 0 分时可紧贴上一单，会标「无缝衔接」及前/后。',
      calPagesHint: '在线预览不同步店家日历，只测界面。要看真预约请在本机打开看板。',
      slotGuideDur: '时长',
      slotGuideGuestEarliest: '人最早',
      slotGuideEarliest: '最早开始',
      slotGuideLatest: '最晚开始（须在关门前做完）',
      slotGuideNone: '该营业时间内做不完',
      slotGuideFull: '当日已满',
      slotSeamHint: '无缝衔接',
      slotSeamBefore: '前无缝',
      slotSeamAfter: '后无缝',
      slotSeamBoth: '前后无缝',
      minGap: '间隔最低时间（分钟）',
      minGapHint: '同一床位两单之间最少空多少分钟。默认 0＝可以无缝接上。',
      ...
      storeOpen: '开门',
      storeClose: '关门',
      storeOvernight: '跨夜营业（关门钟点早于开门）',
      hoursHint: '时间轴按该店营业时间绘制。关到 00:00 请勾选跨夜。改完保存后重新进入该店看板。',
      editResources: '编辑资源与项目',
      editHintNormal: '平时点击卡片进入客服端',
      editHintOn: '编辑模式：右上角切换语言后，只改该语言的名称。',
      doneEdit: '完成编辑',
      ...
      coursesLabel: '预约项目（当前语言，每行一项：可写「id|名称」或仅名称）',
      resCount: '资源数量',
      resNames: '资源名称（当前语言）',
      editLangNow: '正在编辑的语言',
      editLangJp: '日语',
      editLangCn: '中文',
      editLangEn: '英语',
      editLangHint: '用右上角 JP / 中 / EN 切换，三种语言分开改、分开存。',
      resTypeHint: '可改名称并选类型（单人房 / 双人房 / VIP）。每个资源独立预约，双人房之间不绑定。',
      resNamePh: '名称（如 单人房1）',
      resType: '类型',
    },
    en: {
      ...
      bookingReadonly: 'View booking details',
      bookingConfirmHint: '2+ guests — review and tap Confirm. It becomes a normal blue booking.',
      ...
      resourcesUnit: 'Beds',
      bedsUnit: 'Beds',
      dailyEmailTime: 'Daily merchant email (Japan time)',
      saveDailyTime: 'Save send time',
      previewDigest: 'Preview daily digest',
      exportData: 'Export data',
      calIssueMissingStart: 'missing start time',
      calIssueMissingName: 'missing name',
      calIssueMissingService: 'missing service',
      calIssueMissingBeds: 'missing beds',
      importCalendar: 'Sync calendar now',
      pushCalendar: 'Push to calendar',
      pushCalendarHint: 'Write today’s confirmed bookings to the shop calendar. Shop-made events are left untouched.',
      pushCalendarOk: 'Pushed to calendar',
      pushCalendarFail: 'Calendar push failed',
      prevDay: 'Previous day',
      nextDay: 'Next day',
      nextDayMark: 'Next day',
      importJson: 'Import backup',
      resetData: 'Clear this store’s test data',
      slotGuideTitle: 'Earliest new slot (existing bookings counted)',
      slotGuideHint: 'Scans from now. If a slot sits flush against another booking (gap 0), it is marked back-to-back.',
      calPagesHint: 'Online preview does not sync the shop calendar. Use the local board for live bookings.',
      slotGuideDur: 'Duration',
      slotGuideGuestEarliest: ' guests earliest',
      slotGuideEarliest: 'Earliest start',
      slotGuideLatest: 'Latest start (must finish before close)',
      slotGuideNone: 'Does not fit today’s hours',
      slotGuideFull: 'No gap',
      slotSeamHint: 'Back-to-back',
      slotSeamBefore: 'after previous',
      slotSeamAfter: 'before next',
      slotSeamBoth: 'both sides',
      minGap: 'Minimum gap (minutes)',
      minGapHint: 'Shortest empty time between two bookings on the same bed. 0 = back-to-back allowed.',
      ...
      storeOpen: 'Open',
      storeClose: 'Close',
      storeOvernight: 'Overnight (close earlier than open)',
      hoursHint: 'The board uses this store’s hours. Check overnight if closing after midnight.',
      editResources: 'Edit resources & courses',
      editHintNormal: 'Tap a card to open CS',
      editHintOn: 'Edit mode: switch JP / 中 / EN at the top right to edit that language only.',
      ...
      coursesLabel: 'Courses for the current language (one per line: “id|name” or name)',
      resCount: 'Resource count',
      resNames: 'Resource names (current language)',
      editLangNow: 'Editing language',
      editLangJp: 'Japanese',
      editLangCn: 'Chinese',
      editLangEn: 'English',
      editLangHint: 'Use JP / 中 / EN at the top right. Each language is saved separately.',
      resTypeHint:
        'Edit the name and pick a type (Single / Double / VIP). Each resource books independently; double rooms are not paired.',
      resNamePh: 'Name (e.g. Single 1)',
      resType: 'Type',
    },
  };
  ...
  /** 各店可不同：Starry 等先叫「床位」 */
  function resourceNoun() {
    const cfg = global.STORE_CONFIG || {};
    if (cfg.resourceNoun) return localizedText(cfg.resourceNoun, t('resourcesUnit'));
    return t('resourcesUnit');
  }

  function calendarIssueLabel(code) {
    const map = {
      'missing-start': t('calIssueMissingStart'),
      'missing-name': t('calIssueMissingName'),
      'missing-service': t('calIssueMissingService'),
      'missing-beds': t('calIssueMissingBeds'),
    };
